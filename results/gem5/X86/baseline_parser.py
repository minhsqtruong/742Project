...
def plot_stackbar(addr, fields, pos, plottitle="Specify Title", ytitle="Specify Title", legend=None, H="/", glimpse=True, show=False, save_dir=None):
    '''
    addr: the address generated by get_file_addr() function
...
if __name__ == '__main__':
    ...
    plot_stackbar(addr, ["IntAlu", "IntMult", "IntDiv"], pos=2,
                  plottitle="Operations breakdown", ytitle="Percentage (%)", show=True)
    plot_stackbar(addr, ["num_int_register_reads", "num_int_register_writes", "MemRead", "MemWrite"],
    ...
    plot_stackbar(addr, ["dcache.demand_misses::total", "dcache.demand_hits::total"], pos=1,
                  plottitle="DCache hit/miss breakdown", ytitle="Counts",
                  legend=["Misses", "Hits"], show=True)
    plot_stackbar(addr, ["l2.demand_misses::total", "l2.demand_hits::total"], pos=1,
